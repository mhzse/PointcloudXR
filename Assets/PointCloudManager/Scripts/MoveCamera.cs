...
public class MoveCamera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isRotating)
        {
            ...
            transform.parent.RotateAround(transform.parent.position, transform.right, -pos.y * turnSpeed);
            transform.parent.RotateAround(transform.parent.position, Vector3.up, pos.x * turnSpeed);
        }
